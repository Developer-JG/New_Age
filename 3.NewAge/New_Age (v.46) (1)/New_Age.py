...
W_def_item_002 = W_def_item("가죽 신발", 1, 0, 4, 1, 0, 0, 0, 0, 0, 0, "def")
# 1월의 기억으로 구매
...
# 선과 악
g_e_atk_item_01 = g_e_atk_item("세번째 아이 '트리아'", 30000, 100, 5000, "atk")                                                 # 레벨제한 있는지 확인
...
R_atk_item_list_2 = [R_atk_item_801, R_atk_item_802, R_atk_item_803, \
                     R_def_item_801, R_def_item_802, R_def_item_803, R_def_item_804, \
                     R_def_item_701, R_def_item_702, R_def_item_703, R_def_item_704]
...
# 이벤트 및 특수
special_monster_0004 = monster("인내의 돌", 1, 200000, 0, 30, 0, 0, R_atk_item_603, 1, 1)                                  # 드랍 아이템 (렉스의 명작) 확인
    ...
    while True:
        ...
        if type(ans_2) == type(0):
            ...
            if ans == 'atk' or ans == 'def':
                ...
                re_use(self, ans, self.inven[ans], ans_2)
        elif ans_2 == "":
            break
        else:
            print("올바른 숫자를 입력하세요")
...
def main():
    ...
    try:
        ...
        player_1 = Player(player_name, 1, [], [], 60, 0, 0, 0, 50, 0, 0)
        po_count = 0
        ag_count = 0
        ad_count = 0
    ...
    while True:
        ...
        turn_chack(player_1, player_x, player_y, plag)  # 레벨, 위치, 패시브
