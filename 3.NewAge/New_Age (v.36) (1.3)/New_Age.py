...
R_atk_item_602 = R_r_atk_item("렉스의 2번째 명작 '칼날 그림자'",100,140,0,0,70,0,"Rex's masterpiece")
R_atk_item_603 = R_r_atk_item("렉스의 3번째 명작 '녹색 이빨'",4,0,0,0,0,0,"Rex's masterpiece")
...
# 각성된 랙스의 명작
R_atk_item_621 = R_r_atk_item("렉스의 1번째 명작 '그람'",450,80,80,80,35,350,"Rex's masterpiece")
R_atk_item_622 = R_r_atk_item("렉스의 2번째 명작 '발뭉'",200,0,140,0,70,0,"Rex's masterpiece")
R_atk_item_623 = R_r_atk_item("렉스의 3번째 명작 '레바테인'",150,0,0,0,35,0,"Rex's masterpiece")
R_atk_item_624 = R_r_atk_item("렉스의 4번째 명작 '파프니르의 발톱'",250,70,70,0,20,0,"Rex's masterpiece")
R_atk_item_625 = R_r_atk_item("렉스의 5번째 명작 '궁니르'",120,70,0,60,0,300,"Rex's masterpiece")
R_atk_item_626 = R_r_atk_item("렉스의 6번째 명작 '란드그리드'",10,0,0,140,0,650,"Rex's masterpiece")

R_atk_item_631 = R_r_atk_item("렉스의 7번째 명작 '필리아스의 쿠구'",60,0,0,0,100,0,0,"Rex's masterpiece")
R_atk_item_632 = R_r_atk_item("렉스의 8번째 명작 '필리아스의 갑옷'",200,0,0,0,0,0,100,"Rex's masterpiece")
R_atk_item_633 = R_r_atk_item("렉스의 9번째 명작 '필리아스의 바지'",120,35,35,35,0,0,0,"Rex's masterpiece")
R_atk_item_634 = R_r_atk_item("렉스의 10번째 명작 '필리아스의 신발'",10,0,0,0,0,100,0,"Rex's masterpiece")


# 사신수 무기
R_atk_item_701 = R_s_atk_item("사신수 무기 '청룡의 검'",420,50,50,50,120,20,430,"sasinsu")
R_atk_item_702 = R_s_atk_item("사신수 무기 '백호의 도끼'",550,50,120,0,100,0,40,"sasinsu")
R_atk_item_703 = R_s_atk_item("사신수 무기 '주작의 단검'",300,50,20,200,0,90,0,"sasinsu")
R_atk_item_704 = R_s_atk_item("사신수 무기 '현무의 창'",400,50,110,110,0,40,0,"sasinsu")


# 각성한 사신수 무기
R_atk_item_711 = R_s_atk_item("사신수 무기 '청룡의 검'",4000,70,50,50,120,20,430,"sasinsu")
R_atk_item_712 = R_s_atk_item("사신수 무기 '백호의 도끼'",4000,70,120,0,100,0,40,"sasinsu")
R_atk_item_713 = R_s_atk_item("사신수 무기 '주작의 단검'",4000,70,20,200,0,90,0,"sasinsu")
R_atk_item_714 = R_s_atk_item("사신수 무기 '현무의 창'",4000,50,110,110,0,40,0,"sasinsu")


# 사흉수 갑주
R_def_item_701 = R_s_def_item("사흉주 갑옷 '혼돈의 투구'",200,1,100,150,150,150,"sahyungsu")
R_def_item_702 = R_s_def_item("사흉수 갑옷 '도철의 갑옷'",200,2,100,150,150,150,"sahyungsu")
R_def_item_703 = R_s_def_item("사흉주 갑옷 '도올의 바지'",200,3,100,150,150,150,"sahyungsu")
R_def_item_704 = R_s_def_item("사흉수 갑옷 '궁기의 신발'",200,4,100,150,150,150,"sahyungsu")


# 카우아(흑룡)의 검
R_atk_item_801 = R_b_atk_item("힘을 잃은 흑룡의 검",1500,60,70,"black dragon")
R_atk_item_802 = R_b_atk_item("힘을 되찾은 흑룡의 검",2250,65,70,"black dragon")
R_atk_item_803 = R_b_atk_item("힘을 깨우친 카우아의 검",3000,70,70,"black dragon")

# 흑룡의 갑주 (65레벨)
R_def_item_801 = R_d_def_item("흑룡의 갑주 투구",100,1,65,100,100,100,"black dragon")
R_def_item_802 = R_d_def_item("흑룡의 갑주 갑옷",100,2,65,100,100,100,"black dragon")
R_def_item_803 = R_d_def_item("흑룡의 갑주 바지",100,3,65,100,100,100,"black dragon")
R_def_item_804 = R_d_def_item("흑룡의 갑주 신발",100,4,65,100,100,100,"black dragon")


# 흑룡의 갑주 (70레벨)
R_def_item_811 = R_d_def_item("흑룡의 갑주 투구",300,1,70,200,200,200,"black dragon")
R_def_item_812 = R_d_def_item("흑룡의 갑주 갑옷",300,2,70,200,200,200,"black dragon")
R_def_item_823 = R_d_def_item("흑룡의 갑주 바지",300,3,70,200,200,200,"black dragon")
R_def_item_824 = R_d_def_item("흑룡의 갑주 신발",300,4,70,200,200,200,"black dragon")


# 선과 악
g_e_atk_item_01 = g_e_atk_item("세번째 아이 '트리아'",30000,100,5000,"good and evil")
g_e_atk_item_02 = g_e_atk_item("첫번째 아이 '에나'",30000,100,5000,"good and evil")
...
#공격
def attack(player_1, sel_monster, player_or_monster):
    if player_or_monster == "player":
        ...
        elif len(player_1.equipment['atk']) == 1:
                    ...
                    if ans == 'q':
                        ...
                        if sel_monster.health <= 0:
                            ...
                            if len(sel_monster.drop_item_count) != 0:
                                ...
                                print("\n\n")
                            return self
                        attack(player_1, sel_monster, "monster")
                        if self.health <= 0:
                            break
                        turn += 1
                    # 아이템
...
# 무기 장착
def equipment(player_1, use, item, ans):
    while True:
        print_item_2(item[ans])
        ans_1 = input("\n{0} 무기를 장착하시겟습니까? (y / n) : ".format(item[ans].name))
        if ans_1 == "y":
            if len(player_1.equipment[use]) == 2:
                player_1.inven[use].append(pl.equipment[use][1])
                reset_info(player_1, player_1.equipment[use][1], 'd', use)
                del player_1.equipment[use][1]
                player_1.equipment[use].append(item[ans])
                del item[ans]
                reset_info(player_1, player_1.equipment[use][1], 'u', use)
                print("\n{0} 무기를 장착하였습니다: ".format(player_1.equipment[use][1].name))
                input("나가려면(enter)")
                return player_1
                break
            elif len(player_1.equipment[use]) == 1:
                player_1.equipment[use].append(item[ans])
                reset_info(player_1, player_1.equipment[use][1], 'u', use)
                del item[ans]
                print("\n{0} 무기를 장착하였습니다: ".format(player_1.equipment[use][1].name))
