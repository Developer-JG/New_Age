...
item_205 = def_item("백호 갑주",50,45,60,20,"def")
item_206 = def_item("주작 갑주",50,60,1000,30,"def")
item_207 = def_item("청룡 갑주",50,60,1000,30,"def")
item_208 = def_item("현무 갑주",50,60,1000,30,"def")
item_209 = def_item("흑룡 갑주",60,60,1000,30,"def")
item_210 = def_item("기사 갑주",70,80,1000,40,"def")
...
item_605 = creaft_item("흑룡의 검",150,10000,"사신수를 대적하는 흑룡의 혼이 깃든 사흉수 무기이다.",50,"creaft")
# 흑룡의 검(148) = 철검(8) + 칠흑의 검(25) + 악마도끼(30) + 흑빛하늘검(86) + 블랙 드래곤의 검은빛의 숨결 x 5
item_606 = creaft_item("전설의 엑스칼리버",10000,10000,"아서왕 전설에 등장하는 전설의 무기이다.",60,"creaft")
# 사신수중 2개
