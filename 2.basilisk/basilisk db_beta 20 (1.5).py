...
# 플래이어 클래스
class player:
    def __init__(self, name, equipment, inven, health, money, damage, defense, hunger, liv, \
                 exp, cri, ak, m_health, mon_kill):
        self.name = name
...
# 음식 아이템 클래스
class food_item:
    def __init__(self, name, re_hunger, cost, liv, count, use):
        self.name = name
...
# 드롭 아이템 클래스
class drop_item:
    def __init__(self, name, explanation, count, use):
        self.name = name
...
item_301 = re_item("초보자용 회복포션",6,2,1, 1, "re")
item_302 = re_item("일반용 회복포션",16,5,1, 1, "re")
item_303 = re_item("전문가용 회복포션",26,10,5, 1, "re")
item_304 = re_item("고농축 회복포션",36,15,5, 1, "re")
item_305 = re_item("강화된 고농축 회복포션",46,10,10, 1, "re")
item_306 = re_item("천상의 회복포션",56,25,10, 1, "re")
item_307 = re_item("강화된 천상의 회복포션",66,30,10, 1, "re")
item_308 = re_item("생명 열매",76,35,10, 1, "re")
item_309 = re_item("생명 수정",86,40,10, 1, "re")
item_310 = re_item("축복의 손길",100,45,20, 1, "re")
re_item_list = [item_301, item_302, item_303, item_304, item_305, item_306, item_307, \
                 item_308, item_309, item_310]

item_401 = food_item("스켈레톤의 뼈다귀",2,2,0, 1, "food")
item_402 = food_item("마녀의 포화포션",4,4,0, 1, "food")
item_403 = food_item("골렘의 식사",6,6,0, 1, "food")
item_404 = food_item("드래곤의 날갯잎",8,8,0, 1, "food")
food_item_list = [item_401, item_402, item_403, item_404]

item_501 = drop_item("코카트라스의 눈빛","'바실리스크'를 만나러 가자",1, "drop")
item_502 = drop_item("불의 원소","불의 원소이다.",1, "drop")
item_503 = drop_item("물의 원소","물의 원소이다.",1, "drop")
item_504 = drop_item("흙의 원소","흙의 원소이다.",1, "drop")
item_505 = drop_item("바람의 원소","바람의 원소이다.",1, "drop")
item_506 = drop_item("글레이 골렘의 점토조각","무었을 만들수 있을까?",1,"drop")
item_507 = drop_item("플래시 골렘의 살점","이건 먹는게 아니다.",1, "drop")
item_508 = drop_item("아이언골렘의 철조각","제련을 하기에는..;;",1, "drop")
item_509 = drop_item("스톤골렘의 자갈","사람에게 던지면 안된다.",1, "drop")
item_510 = drop_item("골렘의 심장","골렘에게 심장이 있었던가?",1, "drop")
item_511 = drop_item("타다남은 파이어 자이언트의 살점","타다 남은건 먹으면 몸에 안좋다.",1, "drop")
item_512 = drop_item("딱딱한 프로스트 자이언트의 살점","먹다가는 이다 다 부숴질수도..",1, "drop")
item_513 = drop_item("몸에 좋을거 같은 힐 자이언트의 살점","보기에 좋다고 다 먹기좋은건 아니다.",1, "drop")
item_514 = drop_item("돌같은 스톤자이언트의 살점","돌이 사이사이에 밖혀있어 먹기 불편하다.",1, "drop")
item_515 = drop_item("자이언트의 찟어진 옷조각","자이언트의 찢어진 옷조각이다",1, "drop")
item_516 = drop_item("블랙 드래곤의 검은빛의 숨결","검은빛을 띄는 용의 숨결이다.",1, "drop")
item_517 = drop_item("블루 드래곤의 푸른빛의 숨결","푸른빛을 띄는 용의 숨결이다.",1, "drop")
item_518 = drop_item("실버 드래곤의 은빛 숨결","은색을 띄는 용의 숨결이다.",1, "drop")
item_519 = drop_item("골드 드래곤의 금빛 숨결","금색을 띄는 용의 숨결이다.",1, "drop")
item_520 = drop_item("레드 드래곤의 붉은빛 숨결","붉은빛을 띄는 용의 숨결이다.",1, "drop")
item_521 = drop_item("드래곤의 날개짓","드래곤들의 날개짓이다.",1, "drop")
...
item_701 = nomal_item("막대기","일반적인 막대기이다.",0,"item")
item_702 = nomal_item("비밀의 열쇠","어디에 사용하는것일까?",0,"item")
item_703 = nomal_item("보스의 위치 (X)","보스의 X위치를 알려준다.",0,"item")
item_704 = nomal_item("보스의 위치 (Y)","보스의 Y위치를 알려준다.",0,"item")
item_705 = nomal_item("사신수 조합법","원하는 사신수의 조합법을 알려준다.",0,"item")
item_706 = nomal_item("백호의 도끼 조합법","은빛하늘검(40) + 흙의 원소 x 10 + \
                        딱딱한 프로스트 자이언트의 살점 x 5 + 실버 드래곤의 은빛 숨결 x 3",0,"item")
item_707 = nomal_item("주작의 삽 조합법","붉은도끼(30) + 불의 원소 x 10 + \
                        타다남은 파이어 자이언트의 살점 x 5 + 레드 드래곤의 붉은빛 숨결 x 3",0,"item")
item_708 = nomal_item("청룡의 검 조합법","푸른불꽃검(36) + 바람의 원소 x 10 + \
                        몸에 좋을거 같은 힐 자이언트의 살점 x 5 + 골드 드래곤의 금빛 숨결 x 3",0,"item")
item_709 = nomal_item("현무의 낫 조합법","금빛하늘검(46) + 물의 원소 x 10 + \
                        돌같은 스톤자이언트의 살점 x 5 + 블루 드래곤의 푸른빛의 숨결 x 3",0,"item")
item_710 = nomal_item("혼돈의 낫 조합법","칠흑의 검(25) + 글레이 골렘의 점토조각 x 8 + \
                        골렘의 심장 x 5 + 자이언트의 찟어진 옷조각 x 3 + 드래곤의 날개짓",0,"item")
...
def attack(pl, mon, m_health,p_m):
    if p_m == "pl":
        if len(pl.equipment['atk']) == 2:
            per = choice("y" * pl.cri + "n" * (100 - pl.cri))
            if per == 'y':
                damage = pl.damage * 2
            else:
                damage = pl.damage
...
def inventory_print(self ,sel):
    while True:
        ...
        if sel== 'atk' or sel == 'def':
            ...
            for i in range(len(self.inven[sel])):
                print("{0:^12}{1:^12}".format(i+1,self.inven[sel][i].name + "  x"+ str(self.inven[sel][i].count)))
...
def main():
    ...
    if in_name == "":
        print()
    p_1 = player(in_name, [], [], 100, 1000, 0, 0, 10, 1, 0,0,0,100, 0)
    self = p_1
    ...
    while True:
        ...
        if self.hunger > 10:
            self.hunger = 10
        mon_kill = 0
        if self.mon_kill > mon_kill and player_x == 10 and player_y == 10:
            mon_kill = self.mon_kill
            self.hunger = 10
        ...
        if player_x == 10 and player_y == 10:
            pass
        elif player_x == 1 and player_y == 1:
            print("이상한 폐허가 있다. 음산한 기운이 몸을 감싼다")
        else:
            mon_hello(ans, self)
