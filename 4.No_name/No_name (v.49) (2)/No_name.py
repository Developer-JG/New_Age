...
# 각성된 랙스의 명작
R_def_item_631 = R_r_def_item("강화된 랙스의 7번째 명작 '필리아스의 쿠구'", 60, 1, 0, 0, 0, 100, 0, 0, "def")
R_def_item_632 = R_r_def_item("강화된 렉스의 8번째 명작 '필리아스의 갑옷'", 200, 2, 0, 0, 0, 0, 0, 100, "def")
R_def_item_633 = R_r_def_item("강화된 렉스의 9번째 명작 '필리아스의 바지'", 120, 3, 35, 35, 35, 0, 0, 0, "def")
R_def_item_634 = R_r_def_item("강화된 렉스의 10번째 명작 '필리아스의 신발'", 10, 4, 0, 0, 0, 0, 100, 0, "def")
...
# 몬스터 클래스
class monster:
    def __init__(self, name, liv, health, damage, recovery_health, drop_exp, drop_money, drop_item, drop_item_count, point):
        self.name = name
        self.liv = liv
        self.health = health
        self.damage = damage
...
# 이벤트 및 특수
special_monster_0001 = monster("화난소", 0, 300, 100, 100, 15, 0, [], 0, 1)
special_monster_0002 = monster("핀 그리드", 0, 15000, 2500, 4000, 3000, 1000, [R_atk_item_601], 1, 1)  # 렉스의 1번째 명작 '홍염의 날개깃' 드랍
special_monster_0003 = monster("인내의 돌", 1, 200000, 0, 30, 0, 0, [R_atk_item_603], 1, 1)  # 렉스의 3번째 명작 '녹색 이빨' 드랍


monster_list = [nomal_monster_0001,
                ...
                nomal_monster_0301, nomal_monster_0302, nomal_monster_0303, nomal_monster_0304, nomal_monster_0305,
                nomal_monster_0401, nomal_monster_0402,
                nomal_monster_0501, nomal_monster_0502, nomal_monster_0503,
                nomal_monster_0601, nomal_monster_0602, nomal_monster_0603,
                nomal_monster_0701, nomal_monster_0702, nomal_monster_0703, nomal_monster_0704, nomal_monster_0705,
                nomal_monster_0801, nomal_monster_0802, nomal_monster_0803, nomal_monster_0804, nomal_monster_0805,
                nomal_monster_0901, nomal_monster_0902, nomal_monster_0903, nomal_monster_0904, nomal_monster_0905,
                nomal_monster_1001, nomal_monster_1002, nomal_monster_1003, nomal_monster_1004,
                special_monster_0001, special_monster_0002, special_monster_0003]
...
def monster_select(player_1):
    while True:
        select_ = choice(list(monster_list))
        select = monster_list.index(select_) + 1
        if monster_list[select].point == player_1.point:
            select_monster = monster_list[select]
            break
